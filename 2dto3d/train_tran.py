...
network = TransNet(model_id, project_dir="../2dto30/")
network = network.cuda()

train_dataset = DatasetImgNetAugmentation(kitti_data_path="../data/kitti",
                                          kitti_meta_path="..//data/kitti/meta",
                                          type="train")
val_dataset = DatasetImgNetEval(kitti_data_path="../data/kitti",
                                kitti_meta_path="../data/kitti/meta",
                                type="val")
